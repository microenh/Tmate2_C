...
typedef struct _display_bitfield {
    ...
    unsigned int smeter_1r: 4;
    unsigned int: 3;
    unsigned int hz: 1;

    unsigned int smeter_1l: 3;
    unsigned int: 5;

    unsigned int smeter_2r: 4;
    unsigned int: 3;
    unsigned int k: 1;

    unsigned int smeter_2l: 3;
    unsigned int: 5;

    unsigned int smeter_3r: 4;
    unsigned int: 3;
    unsigned int mw_w: 1;

    unsigned int smeter_3l: 3;
    unsigned int smeter_db_minus: 1;
    unsigned int: 3;
    unsigned int mw_m: 1;

    unsigned int smeter_bar12: 1;
    unsigned int smeter_bar13: 1;
    unsigned int smeter_bar14: 1;
    unsigned int smeter_bar15: 1;
    unsigned int: 4;

    unsigned int smeter_bar11: 1;
    ...
    unsigned int rgb_red: 8;
    unsigned int rgb_green: 8;
    unsigned int rgb_blue: 8;
    unsigned int contrast: 8;
    unsigned int refresh: 8;

    unsigned int encoder_speed1: 8;
    unsigned int encoder_speed2: 8;
    unsigned int encoder_speed3: 8;
    unsigned int encoder_trans12: 8;
    unsigned int encoder_trans23: 8;
    unsigned int speed_trans: 8;
